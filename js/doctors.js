...
$('.services:nth-child(2)').click(function(){
    $('.teraphy').slideToggle("slow")
    $('.services:nth-child(2)>i').toggleClass('fa-chevron-right')
})
$('.services:nth-child(4)').click(function(){
    $('.ultra').slideToggle("slow")
    $('.services:nth-child(4)>i').toggleClass('fa-chevron-right')
})
$('.services:nth-child(6)').click(function(){
    $('.rentgen').slideToggle("slow")
    $('.services:nth-child(6)>i').toggleClass('fa-chevron-right')
})
})